" 使用说明
" 插件: vim-plus https://github.com/junegunn/vim-plug
" 插件安装命令: curl -fLo ~/.vim/autoload/plug.vim --create-dirs https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim
" 配置参考 https://github.com/jt9ge/g-vim/blob/master/vimrc
" 第一次初始化,命令:vim ~/.vimrc,进入窗口后, 冒号:PlugInstall
" :PlugInstall
